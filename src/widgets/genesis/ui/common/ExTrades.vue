<template>
  <section
    class="genesis-trades-surface absolute inset-0 z-40 flex min-h-0 flex-col overflow-hidden theme-surface backdrop-blur-3xl pointer-events-auto transition-all duration-300"
    :class="[
