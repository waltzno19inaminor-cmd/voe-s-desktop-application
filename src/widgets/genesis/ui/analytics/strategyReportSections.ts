...
export const strategyReportSections: StrategyReportSection[] = [
  ...
  },
  {
    id: 'capital-growth',
    page: '02',
    title: { en: 'Capital Growth Rate', ru: 'Темп роста капитала' },
    description: { en: 'How quickly the capital changes across trades.', ru: 'Как меняется скорость роста капитала по сделкам.' }
  },
  {
